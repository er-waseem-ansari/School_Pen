            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Stack(
                    children: [
                      Positioned(child: Image.asset('assets/images/profile_screen_images/student_block.png')),
                      Positioned(
                        width: 150,
                        right: 10,
                        top: 10,
                        child: Column(
                          ...
                          children: [
                            ...
                            Text("Eager to learn and grow? Join as a student to access knowledge, engage with peers, and thrives.",style: TextStyle(
                              color: Colors.white
                            ),)
                          ],
                        ),
