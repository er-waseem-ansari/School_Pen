            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Stack(
                    children: [
                      Positioned(child: Image.asset('assets/images/profile_screen_images/parent_block.png')),
                      Positioned(
                        width: 150,
                        right: 10,
                        top: 10,
                        child: Column(
                          ...
                          children: [
                            ...
                            Text("Ready to empower your child's education journey? Choose the parent profile to support and monitor progress.",style: TextStyle(
                                color: Colors.white
                            ),)
                          ],
                        ),
